...
scaleFactor = (str2num(scaleFactor))/100;
...
for i = 1:Npackets
    vid_ts = fread(fid,1,'int32');
    bx = fread(fid,1,'int16');
    by = fread(fid,1,'int16');
    lx = fread(fid,1,'int16');
    ly = fread(fid,1,'int16');

    fseek(fid,-12,0);
    fwrite(fid,vid_ts,'int32');
    fwrite(fid,bx,'int16');
    fwrite(fid,by,'int16');
    fwrite(fid,lx,'int16');
    fwrite(fid,ly,'int16');
