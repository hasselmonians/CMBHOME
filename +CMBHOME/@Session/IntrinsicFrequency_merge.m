function [f_peak, power_ratio] = IntrinsicFrequency_merge(self, cel, print_to_screen, speed_thresh, varargin)
...
power_ratio = zeros(1, 1);
    ...
    if print_to_screen
        ...
        if power_ratio >= pow_rat_thresh && printtext
            text(f_peak+15*.02, ys(2)-diff(ys)*.04, ['Intrinsic Frequency = ' num2str(f_peak) ' Hz'], 'FontSize', 8);
        elseif power_ratio < pow_rat_thresh && printtext
